      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative group hidden md:block">
          ...
          <input 
            ...
            className="pl-10 pr-4 py-2 bg-slate-50 border-none rounded-2xl text-sm w-64 focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all outline-none"
          />
        </div>
      </div>
          ...
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-3 pl-2 pr-1 py-1 hover:bg-slate-50 rounded-2xl transition-all outline-none border border-transparent hover:border-slate-100 group cursor-pointer lg:min-w-[180px]">
              <div className="hidden lg:block text-right">
                ...
                <div className="text-[11px] text-slate-400 font-medium">admin@4sightrx.com</div>
              </div>
